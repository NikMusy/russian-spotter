...
PHRASES: list[Phrase] = [
    ...
    Phrase("penalty_drive_through", "штраф проезд по пит-лейн", P_URGENT, "penalties"),
    Phrase("warning_track_limits", "следи за границами трассы", P_NORMAL, "penalties", core=True,
           hard="съедешь ещё раз - штраф, блядь"),
    Phrase("penalty_served", "штраф отбыт", P_NORMAL, "penalties"),
    Phrase("give_position_back", "верни позицию", P_URGENT, "penalties", core=True),
